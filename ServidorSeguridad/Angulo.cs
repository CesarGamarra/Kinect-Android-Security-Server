...
namespace ServidorSeguridad
{
    public partial class Angulo : Form
    {
        ...
        public void cambiarAngulo(int nuevoAngulo)
        {
            if (nuevoAngulo > miKinect.MinElevationAngle && nuevoAngulo < miKinect.MaxElevationAngle)
                miKinect.ElevationAngle = nuevoAngulo;
        }
    }
}
